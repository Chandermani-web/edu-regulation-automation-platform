  ...
  useEffect(() => {
    if (allInstitutionDetails) {
      const filtered = allInstitutionDetails
        .filter(institution => institution.type === "aicte" && institution.applications?.some(app => app.status === "submitted" && app.isApproved !== true))
        .flatMap(institution => 
...
export default AICTELatestApplication;