...
const SuperAdminNIRFRanking = () => {
  ...
  return (
    <SuperAdminLayout className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-8">
      {/* Header */}
      <div className="mb-8">
...
export default SuperAdminNIRFRanking;