...
const UGCFinalApproval = () => {
  ...
  const complianceStats = useMemo(() => {
    ...
    const compliant = institution.parameters.filter(p => p.is_compliant).length;
  ...
  if (!institution || !application) {
    return (
      <Layout className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            The requested application data could not be loaded. Please verify the URL or return to the dashboard.
          </p>
          <button
  ...
  return (
    <Layout className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 p-4 md:p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">{institution.AISHE_code}</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">
                          {institution.district}, {institution.state} - {institution.pincode}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="p-4 text-left font-semibold text-gray-700 border-b">Parameter</th>
                      <th className="p-4 text-left font-semibold text-gray-700 border-b">Norm</th>
                      <th className="p-4 text-left font-semibold text-gray-700 border-b">Institution</th>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {institution.parameters?.map((param, index) => (
                      ...
                      >
                        <td className="p-4 text-gray-700">{param.parameter_category}</td>
                        <td className="p-4 text-gray-800 font-medium">{param.parameter_name}</td>
                        <td className="p-4 text-gray-600">{param.norm_value}</td>
                        <td className="p-4">
                          ...
                          <div className="flex items-center gap-2">
                            {param.is_compliant ? (
                              ...
                              <>
                                ...
                                <span className="text-red-700 font-semibold">Non-compliant</span>
                              </>
                            )}
                          </div>
                        </td>
                  ...
                  {decision && (
                    <div className={`mt-6 p-4 rounded-xl border ${
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-semibold text-gray-700">Selected Decision</p>
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-semibold">{complianceStats?.total || 0}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-semibold">{institution.documents?.length || 0}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                Are you sure you want to {decision} this application? This action cannot be undone.
              </p>
            </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-yellow-800">
                    <strong>Recommendation:</strong> Adding detailed remarks is recommended before finalizing.
                  </p>
                </div>
              </div>
            )}
...
export default UGCFinalApproval; 