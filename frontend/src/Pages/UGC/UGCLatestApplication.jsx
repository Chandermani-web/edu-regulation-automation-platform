  ...
  useEffect(() => {
    if (allInstitutionDetails) {
      const filtered = allInstitutionDetails
        .filter(institution => institution.type === "ugc" && institution.applications?.some(app => app.status === "submitted" && app.isApproved !== true))
        .flatMap(institution => 
    ...
    <Layout className="">
      <div className="flex flex-col">
        <div className="tracking-wide mb-8 leading-0.5">
          <h2 className="text-2xl font-semibold mb-4">Latest Applications (UGC)</h2>
